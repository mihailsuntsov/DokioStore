                    ...
                    while ($currentCycle < $totalNumOfQueryCycles){
                        ...
                        if($httpcode==200){
                            ...
                            foreach ($array->variations as $crm_variation ) {
                                ...
                                echo('<br>');
                                // $currentProductImagesArray     =    formImagesArray     ($crm_variation->images);
                                // $currentProductCategoriesArray =    formCategoriesArray ($crm_variation->categories);
                                ...
                                $currentVariationObject = array(
                                    ...
                                    //'sold_individually' => $crm_variation->sold_individually, 
                                    'manage_stock' => $crm_variation->manage_stock, 
                                    'backorders' => $crm_variation->backorders, 
                                    // 'purchase_note' => $crm_variation->purchase_note, 
                                    'menu_order' => $crm_variation->menu_order, 
                                    // 'reviews_allowed' => $crm_variation->reviews_allowed,
                                    // 'image' => $crm_variation->image
                                    'image' => [
